...
export default ({history}) => (
    <View style={styles.container} >
        <View style={styles.sidebar}>
            ...
            <TouchableOpacity style={styles.activeButtonContainer} onPress={()=> history.push("/menu")}>
                <View>
            ...
            <TouchableOpacity style={styles.inactiveButtonContainer} onPress={()=> history.push("/analytics")}>
                <View>
        ...
        <View style={styles.body}>
            <ImageBackground source={require('../assets/Home/menuIcon.png')} style={{width:'100%', height:'100%'}} />
            <Text> Menu </Text>
        </View>
